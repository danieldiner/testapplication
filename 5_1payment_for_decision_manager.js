...

{
	"clientReferenceInformation": {
        "code": "Capturefordecisionmanager51"
             // "partner": {
        //     "developerId": "83743",
        //     "solutionId": "83743234"
    },
...
function standaloneHttpSignature(callback) {
	...
	processPost(bodyParam, uri = '', function (error, data, response, statusCode) {
		if (statusCode == 0) {
			console.log("\nSTATUS : SUCCESS  Auth For Decision Manager (HTTP Status = " + statusCode + ")");		
		}
		else {
			console.log("\nSTATUS : ERROR  Auth For Decision Manager (HTTP Status = " + statusCode + ")");
		}
	});
